...
main(){
    ...
    //here I build student3
    Name name2("Mike", 'J', "Badey");
    Date bd2(11,22,1993);
    Program program2("RH", "Buisness", "Finance", "BA");
    Course c1,c2,c3,c4;
    Phone house(203,661,7160);
    Phone cell(203,548,1664);
    ...
    // Here I was getting an error when I tried to use cour[10] as an argument so I commented it out
    //Student s3(name2, program2, bd2, 'M', 12121212, 5, cour[10], home, cell);
